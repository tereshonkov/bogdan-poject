...
export default function Cources() {
  return (
    <section className="flex flex-col items-center relative">
      ...
      <div className="flex flex-wrap gap-[15px] mt-[32px] justify-center">
        <div className="flex flex-col gap-[16px] card-gradient w-[160px] h-[160px] rounded-[10px] transition-all duration-300 ease-out hover:scale-105 hover:opacity-100 px-[10px] py-[16px] border border-[rgba(217,217,217,0.1)]">
        ...
        <div className="flex flex-col gap-[10px] card-gradient w-[160px] h-[160px] rounded-[10px] transition-all duration-300 ease-out hover:scale-105 hover:opacity-100 px-[10px] py-[16px] border border-[rgba(217,217,217,0.1)]">
        ...
        <div className="flex flex-col gap-[6px] card-gradient w-[160px] h-[160px] rounded-[10px] transition-all duration-300 ease-out hover:scale-105 hover:opacity-100 px-[10px] py-[16px] border border-[rgba(217,217,217,0.1)]">
