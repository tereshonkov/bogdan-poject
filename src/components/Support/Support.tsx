...
export default function Support() {
  return (
    <section className="relative flex flex-col justify-center items-center gap-8">
      ...
      />
      <h2 className="[font-family:var(--soyuz)] text-[40px] uppercase leading-[1.15] font-bold text-(--whites) text-center w-[295px]">
